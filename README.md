This is a personal tool that uses RapidOCR screen scanning to read your loot. This tool can not get your banned from BDO as we are not tracking loot from Network packets or reading in game file. The tool is about 98.6% accurate There is a few bugs with the tool read the updated release notes with bugs and added features. Below is a few screenshots of what the tool and its Browser sources its exports for streamers to freely edit and and customize for their streams. 
...
<img width="2560" height="1440" alt="image" src="https://github.com/user-attachments/assets/d03bdafa-9657-4ef1-87a2-74841b08665f" />
